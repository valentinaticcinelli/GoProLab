...
%% improve the time-consistency in egde definition by low pass filtering it

filter_flickers(Participants)


%%        *********RUN THIS ONLY IF ******************
%  files from one actor has to be removed from the final database
