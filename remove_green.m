%removes the pixels from the greenscreen. 
%Called in space_crop_and_removeBG

function [rgbImage, varargout] = remove_green(name,thr,external, internal,sigma,varargin)
